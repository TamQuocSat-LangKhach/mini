local miniHengyiActive = fk.CreateSkill {
...
miniHengyiActive:addEffect("active", {
  ...
  card_filter = function(self, player, to_select, selected)
    if self.interaction.data == "draw2" then
      ...
      return
        #selected == 0 and
        table.contains(player:getTableMark("mini__hengyi-tmp"), to_select) and
